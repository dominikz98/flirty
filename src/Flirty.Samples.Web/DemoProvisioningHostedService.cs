...
/// <summary>
/// Builds the demo dialog when the app starts. Implements <see cref="IHostedLifecycleService"/> and
...
/// HTTP and the schema exists. Because <see cref="StartedAsync"/> is awaited by the host, the dialog is
/// deterministically present after startup (important for the E2E tests).
/// </summary>
public sealed class DemoProvisioningHostedService : IHostedLifecycleService
{
    ...
    /// <param name="httpClientFactory">Factory for the admin client pointing to this app.</param>
