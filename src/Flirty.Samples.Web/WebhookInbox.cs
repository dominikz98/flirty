...
/// </summary>
/// <param name="Event">The fired trigger scope (e.g. <c>OnDialogCompleted</c>).</param>
/// <param name="Payload">The raw JSON body of the delivered notification.</param>
/// <param name="ReceivedAt">Time of receipt.</param>
public sealed record WebhookReceipt(string Event, string Payload, DateTimeOffset ReceivedAt);

/// <summary>
/// Thread-safe in-memory sink for the engine's outbound webhooks received by the inbound receiver
...
public sealed class WebhookInbox
{
    ...
    /// <summary>Records a received webhook.</summary>
