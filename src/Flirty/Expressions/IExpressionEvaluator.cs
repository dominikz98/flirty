...
/// insbesondere <c>Transition.Expression</c> (welcher Übergang greift) und
/// <c>TriggerDefinition.Expression</c> (ob ein Trigger auslöst). Die Auswertung erfolgt
...
/// <c>DynamicExpressoExpressionEvaluator</c> (Member-Whitelist, kein roher C#-<c>eval</c>) folgt in
/// Issue #23, der Compile-/Validierungs-Pfad für den Designer in Issue #24. Registriert und
/// austauschbar wird die Engine über <c>o.UseExpressionEvaluator&lt;T&gt;()</c> in Issue #34.
/// </remarks>
