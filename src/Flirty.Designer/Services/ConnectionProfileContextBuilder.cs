...
/// <summary>
/// Builds a <see cref="FlirtyDbContext"/> from a <see cref="ConnectionProfile"/> – the central
/// seam between profile selection and EF Core. Uses the public core mapping
