...
/// <summary>
/// The analysis result for a loop marker (#41): the loop body derived from the transition graph,
...
/// <param name="Body">
/// The questions of the loop body in dialog order (empty if the entry or breaking question
/// no longer belongs to the dialog).
/// </param>
...
/// The transitions of the breaking question whose target lies <b>within</b> the body (back-jumps),
/// in evaluation order.
/// </param>
/// <param name="ExitTransitions">
/// The transitions of the breaking question whose target lies <b>outside</b> the body (exits),
/// in evaluation order.
/// </param>
/// <param name="TargetedWarnings">
/// The found warnings together with a location (empty if the loop is configured consistently). Since
...
{
    /// <summary>
    /// The warning texts in unchanged order – the view that the loop and dialog editors have shown
    /// since #41.
    /// </summary>
