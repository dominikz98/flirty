...
/// <summary>
/// Form model of the answer-options editor (#39). Deliberately mutable (settable properties), so that
...
{
    /// <summary>The stable, domain-level key of the option (must be unique within the question).</summary>
    ...
    /// <summary>The value of the option stored on selection (the one the answer validator checks).</summary>
