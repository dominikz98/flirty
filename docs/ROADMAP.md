...
> **Stand M5: abgeschlossen** – umgesetzt sind `#100` (Spike Canvas-Technik, Ergebnis
...
> [ADR 0008](./adr/0008-gesten-auf-dem-canvas.md)), `#104` (Testlauf im Graphen, siehe
> [DESIGNER.md § Testlauf im Graphen](./DESIGNER.md#testlauf-im-graphen-104)) und `#105` (Playwright-E2E
> des Canvas, siehe [DESIGNER.md § Tests](./DESIGNER.md#tests)). `#105` hat dabei eine Lücke im Anlege-Flow
> geschlossen, die kein Unit-Test zeigen konnte: Die **Einstiegsfrage** ließ sich nur im Dialog-Editor
> setzen, obwohl der Graph über ihr Fehlen warnte – sie geht jetzt am Knoten.
>
